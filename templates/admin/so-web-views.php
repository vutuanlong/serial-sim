...
<div class="wrap">
	<h1>Thông tin kho Số bán web</h1>
	<div style="display: flex; gap: 15px; margin-top: 10px; justify-content: space-between;">
		<form method="get" style="display:flex; gap:15px;">
			<input type="hidden" name="post_type" value="so-web">
			<input type="hidden" name="page" value="thong-tin-so-web">
			<input type="text"
				name="search_sdt"
